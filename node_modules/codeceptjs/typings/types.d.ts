declare namespace CodeceptJS {
    ...
    class Appium {
         ...
         * ```
         * @param locator - located by CSS|XPath|strict locator.
         * @param alignToTop - (optional) or scrollIntoViewOptions (optional), see https://developer.mozilla.org/en-US/docs/Web/API/Element/scrollIntoView.
         *
         *
         * Supported only for web testing
         */
        scrollIntoView(locator: string | any, alignToTop: boolean | any): void;
        /**
    ...
    class MockRequest {
         ...
         * ```
         * @param method - request method. Can be `GET`, `POST`, `PUT`, etc or `ANY`.
         * @param oneOrMoreUrls - url(s) to mock. Can be exact URL, a pattern, or an array of URLs.
         * @param dataOrStatusCode - status code when number provided. A response body otherwise
         * @param additionalData - response body when a status code is set by previous parameter.
         */
    ...
    class WebDriverIO {
         ...
         * @param fn - function to be executed in browser context.
         * @param args - to be passed to function.
         * @returns Appium: support only web testing
         *
         ...
         * @param [sec = 1] - (optional, `1` by default) time in seconds to wait
         * @param [timeoutMsg = ''] - message to show in case of timeout fail.
         * @param [interval = null] - * *Appium*: supported
         */
        waitUntil(fn: ((...params: any[]) => any) | string, sec?: number, timeoutMsg?: string, interval?: number): void;
        /**
         * Switches frame or in case of null locator reverts to parent.
