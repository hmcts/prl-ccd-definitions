...
module.exports = {
  ...
  async createOrder() {
    ...
    await I.retry(retryCount).click('#createSelectOrderOptions-specialGuardianShip');
  ...
  async guardianPage() {
    ...
    I.wait('2');
    await I.retry(retryCount).fillField('#appointedGuardianName_0_guardianFullName', 'Guardian Name');
    await I.runAccessibilityTest();
    await I.retry(retryCount).click(this.fields.submit);
  },
  async checkOrder() {
