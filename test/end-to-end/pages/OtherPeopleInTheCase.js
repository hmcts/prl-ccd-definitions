...
module.exports = {
  ...
  async otherPeopleInTheCase() {
    ...
    await I.retry(retryCount).fillField('//*[@id="otherPartyInTheCaseRevised_0_addressLivedLessThan5YearsDetails"]', '123 Previous Address 4567');
    await I.retry(retryCount).checkOption('//input[@id="otherPartyInTheCaseRevised_0_canYouProvideEmailAddress_Yes"]');
    await I.retry(retryCount).fillField('//input[@id="otherPartyInTheCaseRevised_0_email"]', 'otherstonotify@email.com');
    await I.retry(retryCount).checkOption('//input[@id="otherPartyInTheCaseRevised_0_isEmailAddressConfidential_Yes"]');
    await I.retry(retryCount).checkOption('//input[@id="otherPartyInTheCaseRevised_0_canYouProvidePhoneNumber_Yes"]');
    await I.retry(retryCount).fillField('//input[@id="otherPartyInTheCaseRevised_0_phoneNumber"]', '07122884667');
    await I.retry(retryCount).checkOption('//input[@id="otherPartyInTheCaseRevised_0_isPhoneNumberConfidential_Yes"]');
